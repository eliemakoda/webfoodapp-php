...
?>
		<div class="inner-banner title-area text-center image-4">
			<div class="container title-area-content">
				<h1 class="animated" data-animation="fadeInUp" data-animation-delay="200">Our Team</h1>
                ...
                <div class="bread-crumb"><a href="#">Home</a> <span>Our Team</span></div>
			</div>
		</div>
		<!-- /. INNER BANNER STARTS
			========================================================================= -->
			...
			<div class="our-team" id="team">
				<div class="container">
					...
					<div class="row">
						...
						<!-- Block Ends -->
						<!-- Block Starts -->
						<div class="col-lg-4 col-md-4 col-sm-6 animated" data-animation="fadeIn" data-animation-delay="1200">
							<div class="block">
						...
						<!-- Block Ends -->
						<!-- Block Starts -->
						<div class="col-lg-4 col-md-4 col-sm-6 animated" data-animation="fadeIn" data-animation-delay="1400">
							<div class="block">
						...
						<div class="col-lg-4 col-md-4 col-sm-6 animated" data-animation="fadeIn" data-animation-delay="800">
							<div class="block">
								<div class="picture"><img src="images/team/5.jpg" class="img-responsive center-block" alt=""></div>
								<div class="name"><a href="#">Jhon doe</a></div>
								<div class="designation">Chef, Co-Founder</div>
								<ul class="social-icons">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 animated" data-animation="fadeIn" data-animation-delay="1000">
							<div class="block">
								<div class="picture"><img src="images/team/6.jpg" class="img-responsive center-block" alt=""></div>
								<div class="name"><a href="#">MARK HENRY</a></div>
								<div class="designation">Master Chef</div>
								<ul class="social-icons">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 animated" data-animation="fadeIn" data-animation-delay="1200">
							<div class="block">
								<div class="picture"><img src="images/team/7.jpg" class="img-responsive center-block" alt=""></div>
								<div class="name"><a href="#">SAMEUL LOE</a></div>
								<div class="designation">Master Grill</div>
								<ul class="social-icons">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 animated" data-animation="fadeIn" data-animation-delay="1400">
							<div class="block">
								<div class="picture"><img src="images/team/8.jpg" class="img-responsive center-block" alt=""></div>
								<div class="name"><a href="#">KAREEM MELO</a></div>
								<div class="designation">Master Sea Foods</div>
								<ul class="social-icons">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 animated" data-animation="fadeIn" data-animation-delay="800">
							<div class="block">
								<div class="picture"><img src="images/team/9.jpg" class="img-responsive center-block" alt=""></div>
								<div class="name"><a href="#">Jhon doe</a></div>
								<div class="designation">Chef, Co-Founder</div>
								<ul class="social-icons">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
...
<!-- Mirrored from miraclestudio.design/html/delicieux/our-team.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jan 2024 12:07:23 GMT -->
</html>