				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4">
						<div class="block">
							...
							<div class="caption">Our Address</div>
							<div class="line"></div>
							<div class="description">32 Nasr City, Abdul Raouf St P.O Box,<br>358 Mukram Abeed View.<br>UEA</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4">
						<div class="block">
							<div class="icon"><i class="fa fa-phone" aria-hidden="true"></i></div>
							<div class="caption">Our Phone Number</div>
							<div class="line"></div>
							<div class="description">Local:  + 022 0100 843 1112<br>Mobile: 0100 8422222<br>Hot Line: 102154</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4">
						<div class="block">
...
<!-- Mirrored from miraclestudio.design/html/delicieux/contact-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jan 2024 12:07:27 GMT -->
</html>